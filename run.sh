...
echo -e "\nwait 10 seconds for nodejs to start"
sleep 10
echo "running third test (returning sum of numbers from 0 to 12345678 using recursion from nodejs web server with 100 concurrent connections and 4 threads in 30 seconds)"
wrk -t4 -c100 -d30s http://localhost:3001/calculate2/12345679
echo -e "\nwait 2 seconds before closing nodejs"
sleep 2
screen -S nodejs -X quit
...
echo -e "\nwait 10 seconds for bun to start"
sleep 10
echo "running third test (returning sum of numbers from 0 to 12345678 using recursion from bun web server with 100 concurrent connections and 4 threads in 30 seconds)"
wrk -t4 -c100 -d30s http://localhost:3000/calculate2/12345679
echo -e "\nwait 2 seconds before closing bun"
sleep 2
screen -S bun -X quit
